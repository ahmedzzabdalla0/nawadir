            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <form action="{{route('system.services.do.update',$out->id)}}" id="form" method="post"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-3">
                                    @component('components.upload_image',['data'=>$out->image,'name'=>'uploaded_image_name','text'=>'صورة الخدمة','hint'=>'400 * 400 بيكسل'])
                                    @endcomponent
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @component('components.input',['data'=>$out->title,'name'=>'name','text'=>'الاسم','placeholder'=>'ادخل الاسم','icon'=>'fa-user-alt'])
                                    @endcomponent
                                </div>
                                <div class="w-100"></div>

                                <div class="col-md-6">
                                    @component('components.area',['data'=>$out->details,'name'=>'details','text'=>'التفاصيل'])
                                    @endcomponent
                                </div>
                            </div>
