            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        <form action="{{route('system.notifications.do.create')}}" id="form" method="post">
                            @csrf
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="w-100"></div>
                                        <div class="col">
                                            <div class="form-group m-form__group @has_error('user_query')">
                                                <label for="user_query">الفئة المستهدفة</label>
                                                <div class="m-input-icon m-input-icon--left m-input-icon--right">
                                                    <div class="input-group">
                                                        <select class="m-input m-input--pill m-input--air" name="user_query" id="user_query" required>
                                                            <option value="0">الكل</option>
                                                            <option value="1">حسابات غير مفعلة</option>
                                                            <option value="2">حسابات بدون طلبات</option>
                                                            <option value="3">مندوبين التوصيل</option>
                                                        </select>
                                                    </div>
                                                </div>
                            ...
                            <div class="col row justify-content-center">
                                ...
                                <a href="{{route('system.notifications.index')}}" class="btn m-btn--pill m-btn--air btn-outline-dark m-btn m-btn--custom">
