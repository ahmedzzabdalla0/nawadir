                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <li class="m-portlet__nav-item">
                                    ...
                                    <a href="{{route('system.notifications.create')}}" class="m-portlet__nav-link btn m-btn--pill m-btn--air btn-outline-primary m-btn m-btn--custom">
