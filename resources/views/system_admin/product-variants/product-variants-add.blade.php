                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        <div style="text-align: right;margin-bottom: 25px;">
                            <h4>الكمية المضافة للمنتج: {{$product->start_qty}}</h4>
                            <input type="hidden" id="added_qty" value="{{$product->start_qty}}">

                        </div>
                        <form id="form"  method="post" action="{{ route('system.product_variants.editVariantsQty') }}">
                            @csrf
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach($out as $o)
                                        <tr id="TR_{{$o->id}}">
                                            ...
                                            <td class="text-center">
                                                <input type="number" class="form-control m-input m-input--pill qty" placeholder="الكمية"
                                                       name="qty[]" min="0" value="0">
                                            </td>
                                            <td class="text-center">
