                            ...
                            <div class="col">
                                <form class="form-inline hide-prnt" style="float: right">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <select name="driver_id" class="autoSubmit" id="" >
                                                <option value="-1" {{HELPER::set_if($_GET['driver_id'],-1) == -1?'selected':''}}>بحث حسب مندوب التوصيل</option>
                                                @foreach($drivers as $r)
                                                    <option value="{{$r->id}}" {{HELPER::set_if($_GET['driver_id']) == $r->id?'selected':''}}>{{$r->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
