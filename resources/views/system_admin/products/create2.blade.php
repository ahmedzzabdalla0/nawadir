...
@section('page_content')
    ...
    <div class="m-content">
        <div class="row">
            <div class="col-lg-12">
                <form action="{{route('system.products.do.create')}}" id="form" method="post">
                <!--begin::Portlet-->
                <div class="m-portlet m-portlet--tabs">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    ...
                                    <button type="submit" style="display: none"  class="m-portlet__nav-link btn m-btn--pill m-btn--air btn-outline-primary m-btn m-btn--custom">
                    ...
                    <div class="m-portlet__body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @component('components.input',['name'=>'name_ar','text'=>'الاسم باللغة العربية','placeholder'=>'ادخل الاسم','icon'=>'fa-user-alt'])
                                    @endcomponent
                                </div>
                                <div class="col-md-6">
                                    @component('components.input',['name'=>'name_en','text'=>'Name in English','placeholder'=>'Enter the name','icon'=>'fa-user-alt'])
                                    @endcomponent
                                </div>
                                <div class="w-100"></div>
                                <div class="col-md-6">
                            ...
                            <div class="tab-content" style="padding: 10px;">
                                <div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            @component('components.select-default',['name'=>'category_id','text'=>'التصنيف','select'=>$categories,'add_url'=>route('system.categories.createJson')])
                                            @endcomponent

                                        </div>
                                        @if($delivery_price_type == 3)
    <div class="col-md-6" style="display: none">
        @component('components.input',['type'=>'number','name'=>'delivery_price','text'=>'سعر الشحن','icon'=>'fa-dollar-sign'])
        @endcomponent
                                ...
                                <div class="tab-pane" id="m_tabs_1_2" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="w-100"></div>
                                        <div class="col-md-6">
                                            @component('components.area_editor',['name'=>'details_ar','text'=>'التفاصيل'])
                                            @endcomponent

                                        </div>
                                        <div class="col-md-6" >
                                            @component('components.area_editor',['name'=>'details_en','text'=>'Details'])
                                            @endcomponent
                                ...
                                <!--    <div class="row">-->
                                <!--        <div class="col-md-12">-->
                                <!--            @component('components.uploadNew')-->
                                <!--            @endcomponent-->
                                <!--        </div>-->
