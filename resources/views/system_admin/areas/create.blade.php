            ...
            <div class="col-lg-12">
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <form action="{{route('system.areas.do.create')}}" id="form" method="post"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6">
                                    @component('components.select',['name'=>'gov_id','text'=>'المدينة','placeholder'=>'هذه مدينة','not_req'=>1,'select'=>$govs])
                                    @endcomponent
                                </div>
                                <div class="w-100"></div>
