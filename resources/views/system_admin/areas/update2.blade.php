                    ...
                    <div class="m-portlet__body">
                        ...
                        <form action="{{route('system.areas.do.update',$out->id)}}" id="form" method="post"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="w-100"></div>
                                <div class="col-md-6">
                                    @component('components.input',['data'=>$out->name,'name'=>'name_ar','text'=>'الاسم','placeholder'=>'ادخل الاسم','icon'=>'fa-user-alt'])
                                    @endcomponent
                                ...
                                <div class="col-md-6">
                                    @component('components.select',['data'=>$out->gov_id,'name'=>'gov_id','text'=>'المدينة','not_req'=>1,'select'=>$govs,'no_def'=>1])
                                    @endcomponent
                                </div>
                            </div>
