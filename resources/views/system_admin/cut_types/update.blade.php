        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="{{route('system.cut_types.index')}}" class="m-nav__link">
            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <form action="{{route('system.cut_types.do.update',$out->id)}}" id="form" method="post"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-3">
                                    @component('components.upload_image',['data'=>$out->image,'name'=>'image','text'=>'صورة التقطيع','hint'=>'400 * 400 بيكسل'])
                                    @endcomponent
                                </div>
                            ...
                            <div class="row  justify-content-center">
                                ...
                                <a href="{{route('system.cut_types.index')}}" style="margin: 10px;" class="btn m-btn--pill m-btn--air btn-outline-metal m-btn m-btn--custom">
