        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{route('system.admin.profile')}}" class="m-nav__link">
            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <form action="{{route('system.admin.do.profile.password')}}" id="form" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group m-form__group @has_error('old_password')">
                                        <label for="old_password">كلمة المرور الحالية </label>
                                        <div class="m-input-icon m-input-icon--left m-input-icon--right">
                                            <input type="password" class="form-control m-input m-input--pill m-input--air" placeholder=" كلمة المرور الحالية"
                                                   required name="old_password" value="@old('old_password')" id="old_password">
                                            <span class="m-input-icon__icon m-input-icon__icon--left"><span><i class="fa fa-lock"></i></span></span>
                                        </div>
                                        @show_error('old_password')
                                ...
                                <div class="col">
                                    ...
                                    <a href="{{route('system.admin.profile')}}" class="btn m-btn--pill m-btn--air btn-outline-metal m-btn m-btn--custom">
