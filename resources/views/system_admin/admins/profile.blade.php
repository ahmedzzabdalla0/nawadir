            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__body">
                        <form action="{{route('system.admin.do.profile',$out->id)}}" id="form" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a href="{{route('system.admin.profile.password')}}" style="margin: 25px auto;"
                                               class="btn m-btn--pill m-btn--air btn-outline-warning m-btn m-btn--custom btn-block" data-aaa="tooltip" title="تغيير كلمة المرور">
                                ...
                                <div class="col-md-2">
                                    ...
                                    @component('components.upload_image',['name'=>'image','data'=>$out->avatar,'text'=>'صورة الحساب','hint'=>'50px * 50px'])@endcomponent
